  ...
  Formbuilder = (function() {
    Formbuilder.helpers = {
      defaultFieldAttrs: function(field_type) {
        var attrs, _base;
        attrs = {};
        attrs[Formbuilder.options.mappings.LABEL] = 'Enter Label';
...
(function() {
  Formbuilder.registerField('Smart Object', {
    order: 0,
    type: 'non_input',
    view: "<label class='section-name'><%= rf.get(Formbuilder.options.mappings.LABEL) %></label>\n<p><%= rf.get(Formbuilder.options.mappings.DESCRIPTION) %></p>",
    edit: "<div class='fb-edit-section-header'>Label</div>\n<input type='text' data-rv-input='model.<%= Formbuilder.options.mappings.LABEL %>' />\n<textarea data-rv-input='model.<%= Formbuilder.options.mappings.DESCRIPTION %>'\n  placeholder='Add a longer description to this field'></textarea>",
    addButton: "<span class='symbol'><span class='fa fa-minus'></span></span> Smart Object"
  });
...
(function() {
  Formbuilder.registerField('text', {
    order: 0,
    view: "<input type='text' placeholder='Text' class='rf-size-<%= rf.get(Formbuilder.options.mappings.SIZE) %>' />",
    edit: "<%= Formbuilder.templates['edit/size']() %>\n<%= Formbuilder.templates['edit/min_max_length']() %>",
...
'\n  </div>\n  <div class=\'fb-common-checkboxes\' style="margin-left:-30px !important">\n    ' +
...
__p += '\n        <a data-field-type="' +
  ((__t = ( f.field_type )) == null ? '' : __t) +  '"style= width:258px; '  +
'" class="' +
  ((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t)  +
'">\n          ' +
((__t = ( f.addButton )) == null ? '' : __t) +
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-left\'>\n  <ul class=\'fb-tabs\'>\n    <li class=\'active\'><a data-target=\'#addField\'>New Property</a></li>\n    <li><a data-target=\'#editField\'>Edit field</a></li>\n  </ul>\n\n  <div class=\'fb-tab-content\'>\n    ' +
...
var __t, __p = '', __e = _.escape;
with (obj) {
  __p += '<div class=\'fb-right mCustomScrollbar\'>\n  <div class=\'fb-no-response-fields\'>Add Properties Here</div>\n  <div class=\'fb-response-fields\'></div>\n</div>\n';
