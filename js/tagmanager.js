  ...
  publicMethods = {
    pushTag: function (tag, ignoreEvents, externalTagId) {
      ...
      if (alreadyInList) {
        ...
        html = '<a href="javascript:void(0)" class="' + privateMethods.tagClasses.call($self)  +'" id="' + newTagId + '"> <span >';
        html += '<span>' + escaped + '</span>';
        html += '<button class="remove-btn tm-tag-remove fa fa-times-circle" id="' + newTagRemoveId + '" TagIdToRemove="' + tagId + '">';
        html += '</button></span> </a>';
